                ...
                database.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if(!(snapshot.child(phone).exists())){//Проверяем,есть ли введенный телефон уже в базе данных,если нет,то добавляем хэшмэп в бд
                            ...
                            Toast.makeText(Reg.this, "Вы зарегестрированы", Toast.LENGTH_SHORT).show();
                            finish();

                        }
                        else{
                            Toast.makeText(Reg.this, "Пользователь с такими данными уже есть", Toast.LENGTH_SHORT).show();
                        }
                    }
